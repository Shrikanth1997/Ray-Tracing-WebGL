...
module.exports = {
    entry: './src/ScenegraphsLightsTextures.ts', //entry point of application
    ...
    output: {
        filename: 'ScenegraphsLightsTextures.js', //name of the final bundled JS file
        path: path.resolve(__dirname, 'out') //put bundled file in this folder
    },
    devtool: 'source-map', //enable source-map for debugging (stepping through). generates ScenegraphsLightsTextures.js.map
    mode: 'development'
};
